                      ...
                      <div class="row p-t-20">
                        ...
                        <div class="col-md-3">
                          <div class="Polaris-Stack__Item">
                            ...
                            <div>
                              <input type="color" id="textColor" style="width:29%" class="colorStyle" name="text_color" value="#ffffff" required="required"><sup class="resetText"><i class="fa fa-undo"></i></sup>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <label class="Polaris-Choice" for="typewriter">
                            <span class="Polaris-Choice__Control">
                              <span class="Polaris-Checkbox">
                                <input id="typewriter" <?php echo $disableSettings; ?> value="disable" type="checkbox" name="typewriter" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                          ...
                          <div class="row" style="margin-bottom: 20px;">
                            ...
                            <div class="col-md-4" style="width: 23%;">
                              <div class="Polaris-Stack__Item">
                                ...
                                <div>
                                  <input type="color" style="width:32%" class="buttonTextColor colorStyle" name="button_text_color" value="#000000"><sup class="resetbtnText"><i class="fa fa-undo"></i></sup>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="Polaris-Stack__Item">
                                ...
                                <div>
                                  <input type="color" style="width:22%" class="buttonBackground colorStyle" name="button_background" value="#ffffff"><sup class="resetbtnBackground remcl"><i class="fa fa-undo"></i></sup>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-md-4">
                          <div class="">
                            ...
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                <div class="Polaris-TextField">
                                  <input id="BarPadding" class="Polaris-TextField__Input" type="number" min="0" name="bar_padding" placeholder="Space between the text and the upper/lower borders" aria-labelledby="PolarisTextField4Label" aria-invalid="false" aria-multiline="false" value="0">
                                  <div class="Polaris-TextField__Backdrop"><span class="inputPX">PX</span></div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-md-4">
                          <div class="">
                            ...
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                <div class="Polaris-TextField">
                                  <input <?php echo $disableSettings; ?> id="SocialSize" class="Polaris-TextField__Input" value="24" type="number" min="0" name="social_font_size" placeholder="Sociall Icon Size" aria-labelledby="PolarisTextField4Label" aria-invalid="false" aria-multiline="false" value="">
                                  <div class="Polaris-TextField__Backdrop"><span class="inputPX">PX</span></div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="row p-t-20" style="<?php echo $addOpacity; ?>">
                        <div class="col-md-5">
                          <div class="">
                            ...
                            <input <?php echo $disableSettings; ?> type="text" id="start-date" name="start_date" class="form-control" value="">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="">
