...
<style>
  ...
  /* .clock {
    ...
    .flip-clock-wrapper ul li a div div.inn{color: <?php echo "black"; ?> ;background-color: white;font-size: 16px;}
    .flip-clock-wrapper ul li{line-height: 22px;width: 41%;height: 56%;}
    .flip-clock-wrapper ul{width: 32px;height: 40px;margin-right: -23px;background: transparent;}
...
<div class="addHeight">
<div class="barinfo " style="margin-top: 35px;">
  <div class="">
    <?php
    ...
    <div class="BarMainDiv" style="background-size: cover!important;<?php echo $background; ?>;font-family: <?php echo $bar_detail->font_family; ?>;color:<?php echo $bar_detail->text_color; ?>; font-size:<?php echo $bar_detail->font_size; ?>px; padding:<?php echo $bar_detail->bar_padding; ?>px;">
      <div class="setStyle abc sentence <?php if($bar_detail->typewriter == ''){ echo "";}else{ echo "typewriter";} ?>" id="AnnouncementBarDemo" style="color:<?php echo $bar_detail->text_color; ?>"><?php echo $bar_detail->bar_text; ?></div>
      <div class="setStyle abc"><?php if($bar_detail->button_name != ''){ ?><button id="AnnouncementBarBtn" type="button" class="<?php echo $bar_detail->btn_style; ?> <?php echo $bar_detail->anim_type; ?> setAnimation" name="button" style="background:<?php echo $backColor; ?>; color:<?php echo $btnText; ?>"><?php echo $bar_detail->button_name; ?></button><?php } ?></div>
      ...
      <span id="addCloseBtn" class=""><?php if($bar_detail->close_btn == 'enable'){ ?> <span class="increaseSize" style="float: right;font-size: <?php echo $bar_detail->close_btn_size.'px'; ?>;padding-right: 5px;"><i class="fa fa-times"></i></span> <?php } ?></span>
    </div><br>
        </div>
    <br>
    ...
    <form action="<?php echo base_url(); ?>Home/update_bar?shop=<?php echo $shop; ?>&bar_id=<?php echo $bar_detail->id; ?>" enctype="multipart/form-data" method="post">
      ...
      <input type="hidden" class="" name="bar_type" value="announce_bar">
                    ...
                    <div class="Polaris-FormLayout__Item">
                      ...
                      <div class="row">
                        ...
                        <!-- <div class="col-md-3" style="padding-top: 50px;">
                          <label class="Polaris-Choice" for="AudioFile">
                            <span class="Polaris-Choice__Control">
                              <span class="Polaris-Checkbox">
                                <input id="AudioFile" type="checkbox" <?php echo $audioChecked; ?> name="audio" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                            ...
                            <span class="Polaris-Choice__Label">Add Audio</span>
                          </label>
                        </div> -->
                      </div>
                      <div class="row p-t-20">
                        ...
                        <div class="col-md-3">
                          <div class="Polaris-Stack__Item">
                            ...
                            <div>
                              <input type="color" id="textColor" style="width:29%" class="colorStyle" name="text_color" value="<?php echo $bar_detail->text_color; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row p-t-20">
                        <div class="col-md-6">
                          ...
                          <label class="Polaris-Choice" for="typewriter" style="<?php echo $addOpacity; ?>">
                            <span class="Polaris-Choice__Control">
                              <span class="Polaris-Checkbox">
                                <input id="typewriter" <?php echo $disableSettings." ". $typewriterChecked; ?> value="disable" type="checkbox" name="typewriter" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                                <span class="Polaris-Checkbox__Backdrop"></span>
                                <span class="Polaris-Checkbox__Icon">
                                  <span class="Polaris-Icon">
                                    <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                          ...
                          <div class="row" style="margin-bottom: 20px;">
                            ...
                            <div class="col-md-4" style="width: 23%;">
                              <div class="Polaris-Stack__Item">
                                ...
                                <div>
                                  <input type="color" style="width:32%" class="buttonTextColor colorStyle" name="button_text_color" value="<?php echo $bar_detail->button_text_color; ?>">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="Polaris-Stack__Item">
                                ...
                                <div>
                                  <input type="color" style="width:22%" class="buttonBackground colorStyle" name="button_background" value="<?php echo $bar_detail->button_background; ?>">
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <div class="Polaris-Card">
                <div class="Polaris-Card__Section">
                  <div class="Polaris-FormLayout">
                    <div class="Polaris-FormLayout__Item">
                      <div class="Polaris-TextContainer">
                        <h2 class="Polaris-Heading">Background Image and Settings</h2>
              ...
              <div class="Polaris-Card">
                <div class="Polaris-Card__Section">
                  <div class="Polaris-FormLayout">
                    <div class="Polaris-FormLayout__Item">
                      <div class="Polaris-TextContainer">
                        <h2 class="Polaris-Heading">Font and Animation Setting</h2>
                      </div>
                      <div class="row p-t-20">
                        <div class="col-md-4">
                          <div class="">
                      ...
                      <div class="row p-t-20" style="<?php echo $addOpacity; ?>">
                        <div class="col-md-4">
                          <div class="">
                            <div class="Polaris-Labelled__LabelWrapper">
                              <div class="Polaris-Label">
                                <label id="FontSizeLabel" for="PolarisTextField4" class="Polaris-Label__Text">Social Icon Size</label>
                              </div>
                            </div>
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                <div class="Polaris-TextField">
                                  <input <?php echo $disableSettings; ?> id="SocialSize" class="Polaris-TextField__Input" type="number" min="0" name="social_font_size" placeholder="Sociall Icon Size" aria-labelledby="PolarisTextField4Label" aria-invalid="false" aria-multiline="false" value="<?php echo $bar_detail->social_icon_size ?>">
                                  <div class="Polaris-TextField__Backdrop"><span class="inputPX">PX</span></div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="row p-t-20">
                        <div class="col-md-5">
                          <div class="">
                            ...
                            <input <?php echo $disableSettings; ?> type="text" id="start-date" name="start_date" class="form-control" value="<?php echo $bar_detail->start_time; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="">
                            ...
                            <input type="text" disabled id="end-date" name="end_date" class="form-control" value="<?php echo $bar_detail->end_time; ?>">
                  ...
                  <div class="Polaris-FormLayout">
                    <div class="Polaris-FormLayout__Item">
                      ...
                      <div class="row p-t-20" style="margin-left: 0px;<?php echo $addOpacity; ?>">
                        <div class="col-md-6">
                          ...
                          <label class="Polaris-Choice" for="addToSlider">
                            <span class="Polaris-Choice__Control">
                              <span class="Polaris-Checkbox">
                                <input id="addToSlider" value="noslider" <?php echo $disableSettings." ".$sliderChecked; ?> type="checkbox" name="add_to_slider" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                                <span class="Polaris-Checkbox__Backdrop"></span>
                                <span class="Polaris-Checkbox__Icon">
                                  <span class="Polaris-Icon">
                                    <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                      ...
                      <div class="row p-t-20">
                        ...
                        <div class="col-md-6 showClosedBtn" style="display:none">
                          <div class="">
                            <div class="Polaris-Labelled__LabelWrapper">
                              <div class="Polaris-Label">
                                <label id="FontSizeLabel" for="PolarisTextField4" class="Polaris-Label__Text">Button Size</label>
                              </div>
                            </div>
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
      ...
      <input type="hidden" class="addInstaVal" name="social_icon_insta" value="">
      <input type="hidden" class="addFaceVal" name="social_icon_face" value="">
      <input type="hidden" class="addLinkVal" name="social_icon_link" value="">
      <input type="hidden" class="addTweetVal" name="social_icon_tweet" value="">
      <center>
...
$(window).on('scroll',function() {
  var addHeight = $(".BarMainDiv").height() + 14;
