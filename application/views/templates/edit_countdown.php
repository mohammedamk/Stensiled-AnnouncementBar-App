...
<div class="barinfo ">
  <div class="">
    <?php
      ( ($bar_detail->background_image == 'NULL' ||$bar_detail->background_image == NULL || $bar_detail->background_image == '') ? $background= "background:".$bar_detail->bar_background : $background= "background: url('". base_url('assets/templates/') .$bar_detail->background_image."')" );
      if ($bar_detail->anim_type == 'gradient-heading' || $bar_detail->anim_type == 'gradient-heading blink') {
        $backColor = '';
        $btnText = '';
      }else {
        $backColor = $bar_detail->button_background;
        $btnText = $bar_detail->button_text_color;
      }
      if ($bar_detail->count_style == 'square') { $countStyle = "0px"; }else if($bar_detail->count_style == 'circle'){ $countStyle = "25px"; }else if($bar_detail->count_style == 'double_circle'){ $countStyle = "13px"; }else if($bar_detail->count_style == 'round' || $bar_detail->count_style == ''){ $countStyle = "6px"; }
      $clockWidth = $bar_detail->font_size * 2;
      $clockHidth = $bar_detail->font_size * 2 + 8;
      $clocklineHeight = $bar_detail->font_size + 6;
      ?>
      <style media="screen">
        .flip-clock-wrapper ul li a div div.inn{background-color: <?php echo $bar_detail->button_background ?>;color:<?php echo $bar_detail->button_text_color; ?> ;background-color: <?php echo $bar_detail->button_background; ?>;font-size: <?php echo $bar_detail->font_size."px"; ?>;}
        ...
        if ($bar_detail->count_style == 'double_circle') {?>
    ...
    <div class="BarMainDiv" style="background-size: cover!important;<?php echo $background; ?>;font-family: <?php echo $bar_detail->font_family; ?>;color:<?php echo $bar_detail->text_color; ?>; font-size:<?php echo $bar_detail->font_size; ?>px; padding:<?php echo $bar_detail->bar_padding; ?>px;">
      <div class="setStyle abc sentence <?php if($bar_detail->typewriter == ''){ echo "";}else{ echo "typewriter";} ?> <?php if($bar_detail->blink_text == 'enable'){ echo "blink"; }else{ echo ""; } ?>" id="AnnouncementBarDemo"><?php echo $bar_detail->bar_text; ?></div>
      <div class="clock setStyle" style="margin-bottom: -24px;"></div>
      <div class="setStyle abc sentence <?php if($bar_detail->typewriter == ''){ echo "";}else{ echo "typewriter";} ?> <?php if($bar_detail->blink_text_after == 'enable'){ echo "blink"; }else{ echo ""; } ?>" id="AnnouncementBarAfter"><?php echo $bar_detail->after_text; ?></div>
      <div class="setStyle abc addbutton"><?php if($bar_detail->button_name != ''){ ?><button id="AnnouncementBarBtn" type="button" class="<?php echo $bar_detail->btn_style; ?> <?php echo $bar_detail->anim_type; ?> setAnimation" name="button" style="background:<?php echo $backColor; ?>; color:<?php echo $btnText; ?>"><?php echo $bar_detail->button_name; ?></button><?php } ?></div>
      <div class="setStyle addMargin"> <span id="addInsta"></span><span id="addTweet"></span><span id="addFace"></span><span id="addLink"></span> </div>
      <span id="addCloseBtn"><?php if($bar_detail->close_btn == 'enable'){ ?> <span class="increaseSize" style="float: right;font-size: <?php echo $bar_detail->close_btn_size.'px'; ?>;padding-right: 5px;"><i class="fa fa-times"></i></span> <?php } ?></span>
    </div><br>
    ...
    <form action="<?php echo base_url(); ?>Home/update_bar?shop=<?php echo $shop; ?>&bar_id=<?php echo $bar_detail->id; ?>" enctype="multipart/form-data" method="post">
      <input type="hidden" class="background_image" name="background_image" value="<?php echo $bar_detail->background_image; ?>">
      <input type="hidden" class="btn_style_value" name="btn_style" value="<?php echo $bar_detail->btn_style; ?>">
      <input type="hidden" class="" name="bar_type" value="count_bar">
      <input type="hidden" class="font_family" name="font_family" value="<?php echo $bar_detail->font_family; ?>">
                    ...
                    <div class="Polaris-FormLayout__Item">
                      ...
                      <div class="row p-t-20">
                        <div class="col-md-6">
                          ...
                          <?php if ($bar_detail->blink_text == 'disable') {
                            $blinkChecked = '';
                          }else {
                            $blinkChecked = 'checked';
                          } ?>
                          <label class="Polaris-Choice" for="BlinkText">
                            <span class="Polaris-Choice__Control">
                              <span class="Polaris-Checkbox">
                                <input <?php echo $blinkChecked; ?> id="BlinkText" value="<?php echo $bar_detail->blink_text; ?>" type="checkbox" name="blink_text" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                        ...
                        <div class="col-md-6">
                          <div class="">
                            ...
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                <div class="Polaris-TextField">
                                  <input id="TextAfterClock" class="Polaris-TextField__Input" aria-labelledby="PolarisTextField3Label" type="text" name="after_text" placeholder="Your after text" aria-invalid="false" aria-multiline="false" value="<?php echo $bar_detail->after_text; ?>" required="required">
                                  <div class="Polaris-TextField__Backdrop"></div>
                                </div>
                              </div>
                            </div>
                          ...
                          <?php if ($bar_detail->blink_text_after == 'disable') {
                            $afterBlinkChecked = '';
                          }else {
                            $afterBlinkChecked = 'checked';
                          } ?>
                          <label class="Polaris-Choice" for="BlinkTextAfter">
                            <span class="Polaris-Choice__Control">
                              <span class="Polaris-Checkbox">
                                <input <?php echo $afterBlinkChecked; ?> id="BlinkTextAfter" value="<?php echo $bar_detail->blink_text_after; ?>" type="checkbox" name="blink_text_after" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                                <span class="Polaris-Checkbox__Backdrop"></span>
                                <span class="Polaris-Checkbox__Icon">
                                  <span class="Polaris-Icon">
                                    <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                      ...
                      <div class="row p-t-20">
                        <div class="col-md-3">
                          <div class="Polaris-Stack__Item">
                            ...
                            <div>
                              <input type="color" id="barBackground" class="colorStyle" name="bar_background" value="<?php echo $bar_detail->bar_background; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="Polaris-Stack__Item">
                            ...
                            <div>
                              <input type="color" id="textColor" style="width:29%" class="colorStyle" name="text_color" value="<?php echo $bar_detail->text_color; ?>" required="required">
                            </div>
                          </div>
                        </div>
                      </div>
                      <?php if ($bar_detail->typewriter == '' || $bar_detail->typewriter == 'disable') {
                        $typewriterChecked = '';
                      }else {
                        $typewriterChecked = 'checked';
                      } ?>
                      <div class="row p-t-20" style="margin-left: 0px;<?php echo $addOpacity; ?>">
                        <label class="Polaris-Choice" for="typewriter">
                          <span class="Polaris-Choice__Control">
                            <span class="Polaris-Checkbox">
                              <input id="typewriter" value="<?php echo $bar_detail->typewriter; ?>" <?php echo $disableSettings." ".$typewriterChecked; ?> type="checkbox" name="typewriter" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                              <span class="Polaris-Checkbox__Backdrop"></span>
                              <span class="Polaris-Checkbox__Icon">
                                <span class="Polaris-Icon">
                                  <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                  ...
                  <div class="Polaris-FormLayout">
                    <div class="Polaris-FormLayout__Item">
                      ...
                      <div class="Polaris-Label" style="margin-top: 10px;">
                        ...
                        <label class="switch">
                          <input id="AudioFile" <?php echo $audioChecked; ?> type="checkbox">
                  ...
                  <div class="Polaris-FormLayout">
                    <div class="Polaris-FormLayout__Item">
                      ...
                      <div class="Polaris-Label" style="margin-top: 10px;">
                        ...
                        <label class="switch">
                          <input id="enableButton" <?php echo $buttonChecked; ?> type="checkbox">
                          <span class="slider round"></span>
                        </label>
                      </div>
                      <div class="showHideButton" style="display:none;">
                          ...
                          <div class="col-md-6">
                            <div class="">
                              ...
                              <div class="Polaris-Connected">
                                <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                  <div class="Polaris-TextField">
                                    <input id="ButtonText" class="Polaris-TextField__Input" type="text" name="button_name" placeholder="e.g Check the product" aria-labelledby="PolarisTextField4Label" aria-invalid="false" aria-multiline="false" value="<?php echo $bar_detail->button_name; ?>">
                                    <div class="Polaris-TextField__Backdrop"></div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="">
                              ...
                              <div class="Polaris-Connected">
                                <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                  <div class="Polaris-TextField">
                                    <input id="ButtonLink" class="Polaris-TextField__Input" type="text" name="button_link" placeholder="e.g https://google.com/" aria-labelledby="PolarisTextField4Label" aria-invalid="false" aria-multiline="false" value="<?php echo $bar_detail->button_link; ?>">
                                    <div class="Polaris-TextField__Backdrop"></div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <?php if ($bar_detail->target == '_self') {
                          $tagetChecked = '';
                        }else {
                          $tagetChecked = 'checked';
                        } ?>
                        <div class="row p-t-20">
                          <div class="col-md-6">
                            <div class="">
                              <label class="Polaris-Choice" for="PolarisCheckbox2">
                                <span class="Polaris-Choice__Control">
                                  <span class="Polaris-Checkbox">
                                    <input id="PolarisCheckbox2" <?php echo $tagetChecked; ?> type="checkbox" name="target" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false" value="_blank">
                                    <span class="Polaris-Checkbox__Backdrop"></span>
                                    <span class="Polaris-Checkbox__Icon">
                                      <span class="Polaris-Icon">
                                        <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                        ...
                        <div class="p-t-20">
                          <div class="row" style="margin-bottom: 20px;">
                            <div class="col-md-4">
                              <div class="Polaris-Labelled__LabelWrapper">
                                <div class="Polaris-Label">
                                  <label id="BarPaddingLabel" for="PolarisTextField4" class="Polaris-Label__Text">Animations</label>
                                </div>
                              </div>
                              <div class="Polaris-Select">
                                <select id="Animation" name="anim_type" class="getAnimation Polaris-Select__Input desktop_bar_position" aria-invalid="false">
                                  <option value="" disabled="disabled">Select Animation</option>
                                  <option <?php if($bar_detail->anim_type == 'none'){ echo "selected=selected";} ?> value="none">No Animation</option>
                                  <option <?php if($bar_detail->anim_type == 'blink'){ echo "selected=selected";} ?> value="blink">Blink Button</option>
                                  <option <?php if($bar_detail->anim_type == 'gradient-heading'){ echo "selected=selected";} ?> value="gradient-heading">Gradient Text</option>
                                  <option <?php if($bar_detail->anim_type == 'gradient-heading blink'){ echo "selected=selected";} ?> value="gradient-heading blink">Gradient + Blink</option>
                                </select>
                            ...
                            <?php
                            if ($bar_detail->anim_type == 'gradient-heading blink' || $bar_detail->anim_type == 'gradient-heading') {
                            ...
                            <div class="col-md-4" style="width: 23%;">
                              <div class="Polaris-Stack__Item">
                                ...
                                <div>
                                  <input type="color" <?php echo $disableColor; ?> style="width:32%" class="buttonTextColor colorStyle buttonTextColor1" name="button_text_color" value="<?php echo $bar_detail->button_text_color; ?>">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="Polaris-Stack__Item">
                                ...
                                <div>
                                  <input type="color" <?php echo $disableColor; ?> style="width:22%" class="buttonBackground colorStyle buttonBackground1" name="button_background" value="<?php echo $bar_detail->button_background; ?>">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="">
                            ...
                            <div class="Polaris-Select">
                              <select id="ShowBar" name="show_bar" class="Polaris-Select__Input desktop_bar_position" aria-invalid="false" required="required">
                                ...
                                <option value="home" <?php if($bar_detail->show_bar == 'home'){ echo "selected=selected";} ?>>Home Page</option>
                                <option value="all" <?php if($bar_detail->show_bar == 'all'){ echo "selected=selected";} ?>>All Page</option>
                              </select>
                              <div class="Polaris-Select__Content" aria-hidden="true"><span class="Polaris-Select__Icon desktop_bar_icon"><span class="Polaris-Icon"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                                <path d="M13 8l-3-3-3 3h6zm-.1 4L10 14.9 7.1 12h5.8z" fill-rule="evenodd"></path></svg></span></span>
                              </div>
                      ...
                      <div class="row p-t-20">
                        <div class="col-md-4">
                          <div class="">
                            <div class="Polaris-Labelled__LabelWrapper">
                              <div class="Polaris-Label">
                                <label id="FontSizeLabel" for="PolarisTextField4" class="Polaris-Label__Text">Fonts</label>
                              </div>
                            </div>
                            <div id="loadFont"></div>
                          </div>
                        ...
                        <div class="col-md-4">
                          <div class="">
                            <div class="Polaris-Labelled__LabelWrapper">
                              <div class="Polaris-Label">
                                <label id="FontSizeLabel" for="PolarisTextField4" class="Polaris-Label__Text required">Font Size</label>
                              </div>
                            </div>
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                      ...
                      <div class="row p-t-20" style="<?php echo $addOpacity; ?>">
                        <div class="col-md-4">
                          <div class="">
                            <div class="Polaris-Labelled__LabelWrapper">
                              <div class="Polaris-Label">
                                <label id="FontSizeLabel" for="PolarisTextField4" class="Polaris-Label__Text required">Social Icon Size</label>
                              </div>
                            </div>
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                <div class="Polaris-TextField">
                                  <input id="SocialSize" class="Polaris-TextField__Input" type="number" min="0" name="social_font_size" placeholder="Sociall Icon Size" aria-labelledby="PolarisTextField4Label" aria-invalid="false" aria-multiline="false" value="<?php echo $bar_detail->social_icon_size ?>" required="required">
                                  <div class="Polaris-TextField__Backdrop"><span class="inputPX">PX</span></div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="row p-t-20">
                        <div class="col-md-5">
                          <div class="">
                            ...
                            <input type="text" id="start-date" name="start_date" class="form-control" value="<?php echo $bar_detail->start_time; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="">
                            ...
                            <input type="text" id="end-date" name="end_date" class="form-control" value="<?php echo $bar_detail->end_time; ?>">
                            <div id="end_date_error"></div>
                          </div>
                        </div>
                        <div class="col-md-2">
                          <div class="" style="margin-top: 29px;">
                            <button disabled type="button" data-btn-style="vw-btn" class="btn btn-primary get-date" name="button">Apply Date</button>
                          </div>
                        </div>
                      </div>
                      <div class="row p-t-20 hideColorSettings">
                        <div class="col-md-4" style="width: 23%;">
                          <div class="Polaris-Stack__Item">
                            ...
                            <div>
                              <input type="color" style="width:32%" class="buttonTextColor colorStyle buttonTextColor1" name="button_text_color" value="<?php echo $bar_detail->button_text_color; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="Polaris-Stack__Item">
                            ...
                            <div>
                              <input type="color" style="width:22%" class="buttonBackground colorStyle buttonBackground1" name="button_background" value="<?php echo $bar_detail->button_background; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="Polaris-Card__Section">
                  <div class="Polaris-FormLayout">
                    <div class="Polaris-FormLayout__Item">
                      ...
                      <div class="row p-t-20" style="margin-left: 0px;">
                        <?php if ($bar_detail->add_to_slider == '' || $bar_detail->add_to_slider == 'noslider') {
                          $sliderChecked = '';
                        }else {
                          $sliderChecked = 'checked';
                        } ?>
                        <label class="Polaris-Choice" for="addToSlider" style="<?php echo $addOpacity; ?>">
                          <span class="Polaris-Choice__Control">
                            <span class="Polaris-Checkbox">
                              <input id="addToSlider" value="<?php echo $bar_detail->add_to_slider; ?>" <?php echo $disableSettings." ".$sliderChecked; ?> type="checkbox" name="add_to_slider" class="Polaris-Checkbox__Input" aria-invalid="false" role="checkbox" aria-checked="false">
                              <span class="Polaris-Checkbox__Backdrop"></span>
                              <span class="Polaris-Checkbox__Icon">
                                <span class="Polaris-Icon">
                                  <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                      ...
                      <div class="row p-t-20">
                        <div class="col-md-4" style="<?php echo $addOpacity; ?>">
                          ...
                          <div class="Polaris-Select">
                            <select id="" <?php echo $disableSettings; ?> name="count_box_style" class="count_box_style Polaris-Select__Input desktop_bar_position" aria-invalid="false" required="required">
                              <option value="" selected="selected">Select Style</option>
                              <option <?php if($bar_detail->count_style == 'square'){ echo "selected=selected";} ?> value="square">Square</option>
                              <option <?php if($bar_detail->count_style == 'circle'){ echo "selected=selected";} ?> value="circle">Circle</option>
                              <option <?php if($bar_detail->count_style == 'double_circle'){ echo "selected=selected";} ?> value="double_circle">Double Circle</option>
                              <option <?php if($bar_detail->count_style == 'round' || $bar_detail->count_style == ''){ echo "selected=selected";} ?> value="round">Rounded</option>
                            </select>
                            <div class="Polaris-Select__Content" aria-hidden="true"><span class="Polaris-Select__Icon desktop_bar_icon"><span class="Polaris-Icon"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                              <path d="M13 8l-3-3-3 3h6zm-.1 4L10 14.9 7.1 12h5.8z" fill-rule="evenodd"></path></svg></span></span>
                            </div>
                          ...
                          <!-- <div class="Polaris-Connected">
                            <select <?php echo $disableSettings; ?> class="form-control count_box_style" name="closed_btn">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="Polaris-Select">
                            <select id="" name="closed_btn" class="closed_btn Polaris-Select__Input desktop_bar_position" aria-invalid="false" required="required">
                              <option <?php if($bar_detail->close_btn == 'disable'){ echo "selected=selected"; } ?> value="disable">No</option>
                              <option <?php if($bar_detail->close_btn == 'enable'){ echo "selected=selected"; } ?> value="enable">Yes</option>
                            </select>
                            <div class="Polaris-Select__Content" aria-hidden="true"><span class="Polaris-Select__Icon desktop_bar_icon"><span class="Polaris-Icon"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                              <path d="M13 8l-3-3-3 3h6zm-.1 4L10 14.9 7.1 12h5.8z" fill-rule="evenodd"></path></svg></span></span>
                            </div>
                          ...
                          <!-- <div class="Polaris-Connected">
                            <select class="form-control closed_btn" name="closed_btn">
                        ...
                        <div class="col-md-4 showClosedBtn" style="display:none">
                          <div class="">
                            ...
                            <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                <div class="Polaris-TextField">
                                  <input id="closeButtonSize" class="Polaris-TextField__Input" type="number" min="0" name="close_btn_size" placeholder="closed button size" aria-labelledby="PolarisTextField4Label" aria-invalid="false" aria-multiline="false" value="<?php echo $bar_detail->close_btn_size; ?>">
                                  <div class="Polaris-TextField__Backdrop"><span class="inputPX">PX</span></div>
                                </div>
                              </div>
                            </div>
      ...
      <center>
        ...
        <button type="submit" class="remAttr Polaris-Button Polaris-Button--primary"><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Update</span></span></button>
      </center><br><br>
    </form>
  </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#closeButtonSize').change(function(){
  ...
  if (xhr.status != 200) {
    ...
    html +=	'<button style="width: 100%;" class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Select Font Family <span class="caret"></span></button>'
    ...
    for (x in fontDataArray) {
      html += '<li role="presentation" class="getFont" data-fontname="'+fontDataArray[x].family+'" style="font-family: '+fontDataArray[x].family+'; font-weight: 200line-height: 1.8rem;padding-left: 15px;">';
...
$(document).on('click',".getFont", function() {
  ...
  $('.dropdown-toggle').css('font-family',getFont);
  $('.dropdown-toggle').html(getFont+"<span style='float: right;margin-right: 15px;margin-top: 10px;' class='caret'></span>");
...
<script type="text/javascript">
$(document).ready(function() {
  var getInstaVal = '<?php echo $bar_detail->social_icon_insta; ?>';
  var splitInstaVal = getInstaVal.split('$#');
  if (splitInstaVal[0] != '') {
    var createInsta = '<a target="_blank" href="'+splitInstaVal[1]+'"><img width="20" height="20" src="<?php echo base_url('assets/social_icon/'); ?>'+splitInstaVal[0]+'"></a>';
    $('#addInsta').html(createInsta);
    var socialImage = '<img src="<?php echo base_url('assets/social_icon/'); ?>'+splitInstaVal[0]+'" alt="" width="18" height="18">'
    $('#instagram').html(socialImage+"<span style='float: right;margin-right: 15px;margin-top: 10px;' class='caret'></span>");
    $('.insta-input').val(splitInstaVal[1]);
  }

  var getfaceVal = '<?php echo $bar_detail->social_icon_face; ?>';
  var splitfaceVal = getfaceVal.split('$#');
  if (splitfaceVal[0] != '') {
    var createFace = '<a target="_blank" href="'+splitfaceVal[1]+'"><img width="20" height="20" src="<?php echo base_url('assets/social_icon/'); ?>'+splitfaceVal[0]+'"></a>';
    $('#addFace').html(createFace);
    var socialImage3 = '<img src="<?php echo base_url('assets/social_icon/'); ?>'+splitfaceVal[0]+'" alt="" width="18" height="18">'
    $('#facebook').html(socialImage+"<span style='float: right;margin-right: 15px;margin-top: 10px;' class='caret'></span>");
    $('.face-input').val(splitfaceVal[1]);
  }

  var getLinkVal = '<?php echo $bar_detail->social_icon_link; ?>';
  var splitLinkVal = getLinkVal.split('$#');
  if (splitLinkVal[0] != '') {
    var createLink = '<a target="_blank" href="'+splitLinkVal[1]+'"><img width="20" height="20" src="<?php echo base_url('assets/social_icon/'); ?>'+splitLinkVal[0]+'"></a>';
    $('#addLink').html(createLink);
    var socialImage2 = '<img src="<?php echo base_url('assets/social_icon/'); ?>'+splitLinkVal[0]+'" alt="" width="18" height="18">'
    $('#linkedin').html(socialImage2+"<span style='float: right;margin-right: 15px;margin-top: 10px;' class='caret'></span>");
    $('.link-input').val(splitLinkVal[1]);
  }

  var getTweetVal = '<?php echo $bar_detail->social_icon_tweet; ?>';
  var splitTweetVal = getTweetVal.split('$#');
  if (splitTweetVal[0] != '') {
    var createTweet = '<a target="_blank" href="'+splitTweetVal[1]+'"><img width="20" height="20" src="<?php echo base_url('assets/social_icon/'); ?>'+splitTweetVal[0]+'"></a>';
    $('#addTweet').html(createTweet);
    var socialImage3 = '<img src="<?php echo base_url('assets/social_icon/'); ?>'+splitTweetVal[0]+'" alt="" width="18" height="18">'
    $('#twitter').html(socialImage3+"<span style='float: right;margin-right: 15px;margin-top: 10px;' class='caret'></span>");
    $('.tweet-input').val(splitTweetVal[1]);
  }
  ...
  var start_date = '<?php echo $bar_detail->start_time; ?>';
  var currentDate = new Date();
  ...
  var end_date = '<?php echo $bar_detail->end_time; ?>';
