...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  function GetActionButton2($blockUser){
    $html = '<span style="overflow: visible; position: relative; width: 80px;">
               <div class="dropdown">
                 <a aria-expanded="false" data-toggle="dropdown">
                   <i class="glyphicon glyphicon-option-horizontal" style="cursor:pointer"></i>
                 </a>
                 <div class="dropdown-menu dropdown-menu-right" style="position: absolute; top: 0px; left: -65px; transform: translate3d(-22px, 33px, 0px);" x-placement="bottom-end">
                   <ul style="list-style: none;">'.$blockUser . '
                   </ul>
                 </div>
               </div>
             </span>';
